...
const hf = (data: ProposalData, key: string) => data.hiddenFields?.[key];
    ...
    <>
      <div data-proposal-page className="slide-shadow">
        <div className="slide watermark-light" data-slide style={slideStyle}>
          ...
          {!hf(data, 'estrategiaIntro') && v(data.estrategiaIntro) && (
          ...
          {!hf(data, 'movimento1Title') && v(data.movimento1Title) && (
          ...
          {!hf(data, 'movimento1Intro') && v(data.movimento1Intro) && (
      ...
      <div data-proposal-page className="slide-shadow">
        <div className="slide watermark-light" data-slide style={slideStyle}>
          {!hf(data, 'movimento1Item3') && v(data.movimento1Item3) && (
          ...
          {!hf(data, 'movimento1Resultado') && v(data.movimento1Resultado) && (
      ...
      <div data-proposal-page className="slide-shadow">
        <div className="slide watermark-light" data-slide style={slideStyle}>
          {!hf(data, 'movimento2Title') && v(data.movimento2Title) && (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            {([
              ...
              !hf(data, item.key) && v((data as any)[item.key]) ? (
      ...
      <div data-proposal-page className="slide-shadow">
        <div className="slide watermark-light" data-slide style={slideStyle}>
          {!hf(data, 'movimento3Title') && v(data.movimento3Title) && (
            <div style={{ background: 'rgba(26,58,92,0.05)', borderRadius: 8, padding: '12px 16px', marginBottom: 24 }}>
          ...
          {!hf(data, 'movimento3Body') && v(data.movimento3Body) && (
