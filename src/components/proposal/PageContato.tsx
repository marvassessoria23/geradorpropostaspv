...
const PageContato: React.FC<Props> = ({ data, textSizeClass, pageNumber, bgColor, onChange }) => {
  ...
  return (
    <div className="slide watermark-light" data-slide style={{ width: 1280, height: 720, overflow: 'hidden', display: 'flex', padding: 0, backgroundColor: bgColor || '#f5f0e8', boxSizing: 'border-box', position: 'relative' }}>
      {data.fotoContato && (
